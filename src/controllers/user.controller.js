...
const getUserChannelProfile = asyncHandler(async(req,res)=>{
    const {username} = req.params   // Fetch From URL so use Params
    if(!username?.trim()){
    ...
    const channel = await User.aggregate([
        ...
        },
        {
            $addFields : {
                ...
                isSubscribed : {      //Check User Subscribed or not my channel
                    $cond : {
